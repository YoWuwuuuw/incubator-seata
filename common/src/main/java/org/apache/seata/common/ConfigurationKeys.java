...
public interface ConfigurationKeys {
    ...
    /**
     * The constant SERVER_REGISTRY_ENABLE_METADATA_PREFIX
     */
    String SERVER_REGISTRY_ENABLE_METADATA = SERVER_PREFIX + FILE_ROOT_REGISTRY + ".enableMetadata";

    /**
     * The constant CLIENT_REGISTRY_ENABLE_METADATA_PREFIX
     */
    String CLIENT_REGISTRY_ENABLE_METADATA = SERVER_PREFIX + FILE_ROOT_REGISTRY + ".enableMetadata";
